...
Is an application that calculates how much time before a certain date in the future and displays the countdown for you.

## Basic feature:
1. Submit a date in the future in the following format: Month DD, YYYY.

Open the app here: https://abelhect.github.io/countdownchamp/
